                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <input
                                    ...
                                    min="0"
                                    step="0.01"
                                    class="form-control float-right field-bold"
                                    v-model="contact_nc_data.nc_medical"
                                >
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <table>
                            <tr>
                                <td>
                                    <b-form-checkbox
                                        v-model="contact_nc_data.nc_medical_follow"
                                        @change="follow_benchmark('nc_medical')"
                                    ></b-form-checkbox>
                                </td>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th width="5%">
                                            <i
                                                class="btn btn-secondary clickable fas fa-chevron-down"
                                        ...
                                        <th class="fit">
                                            <i
                                                class="fas fa-plus btn btn-primary float-right"
                                                @click="addField('medical',tindex)"
                                            > Add</i>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody
                                    :id="tindex"
                                    class="collapse show table-td-padding"
                                >
                                    <tr v-for="(data,index) in tdata">
                                        <td align="center">
                                            <i
                                                class="fas fa-lg fa-minus-circle text-danger icon-button"
                                                style="padding-top: 2px;"
                                                @click="removeRow('medical',tindex,index)"
                                            ></i>
                                        </td>
                                        <td>
                                            <input
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <input
                                    ...
                                    step="0.01"
                                    class="form-control float-right field-bold"
                                    v-model="contact_nc_data.nc_critical_illness"
                                >
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <table>
                            <tr>
                                <td>
                                    <b-form-checkbox
                                        v-model="contact_nc_data.nc_critical_illness_follow"
                                        @change="follow_benchmark('nc_critical_illness')"
                                    ></b-form-checkbox>
                                </td>
                        ...
                        <div
                            class="table-responsive"
                            v-for="(tdata,tindex) in critical_illness"
                        >
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <i
                                                class="fas fa-plus btn btn-primary float-right"
                                                @click="addField('critical_illness',tindex)"
                                            > Add</i>
                                        </th>
                                    </tr>
                                </thead>
                                    ...
                                    <tr v-for="(data,index) in tdata">
                                        <td align="center">
                                            <i
                                                class="fas fa-lg fa-minus-circle text-danger icon-button"
                                                style="padding-top: 2px;"
                                                @click="removeRow('critical_illness',tindex,index)"
                                            ></i>
                                        </td>
                                        <td>
                                            <input
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <input
                                    ...
                                    step="0.01"
                                    class="form-control float-right field-bold"
                                    v-model="contact_nc_data.nc_death_tpd"
                                >
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <table>
                            <tr>
                                <td>
                                    <b-form-checkbox
                                        v-model="contact_nc_data.nc_death_tpd_follow"
                                        @change="follow_benchmark('nc_death_tpd')"
                                    ></b-form-checkbox>
                                </td>
                        ...
                        <div
                            class="table-responsive"
                            v-for="(tdata,tindex) in death_tpd"
                        >
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <i
                                                class="fas fa-plus btn btn-primary float-right"
                                                @click="addField('death_tpd',tindex)"
                                            > Add</i>
                                        </th>
                                    </tr>
                                </thead>
                                    ...
                                    <tr v-for="(data,index) in tdata">
                                        <td align="center">
                                            <i
                                                class="fas fa-lg fa-minus-circle text-danger icon-button"
                                                style="padding-top: 2px;"
                                                @click="removeRow('death_tpd',tindex,index)"
                                            ></i>
                                        </td>
                                        <td>
                                            <input
                                        ...
                                        <td
                                            align="right"
                                            class="fit"
                                            v-if="typeof(data.amount) != 'undefined' && data.amount !== null"
                                        >
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">$</span>
                                        ...
                                        <td
                                            align="right"
                                            class="fit"
                                            v-if="typeof(data.installment) != 'undefined' && data.installment !== null"
                                        >
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">$</span>
                                        ...
                                        <td
                                            align="right"
                                            class="fit"
                                            v-if="typeof(data.year) != 'undefined' && data.year !== null"
                                        >
                                            <input
                                                type="number"
                                                class="form-control"
                                        ...
                                        <td
                                            align="right"
                                            class="fit"
                                            v-if="typeof(data.return_percent) != 'undefined' && data.return_percent !== null"
                                        >
                                            <input
                                                type="number"
                                                class="form-control"
                                        ...
                                        <td
                                            align="right"
                                            class="fit"
                                            v-if="typeof(data.inflation) != 'undefined' && data.inflation !== null"
                                        >
                                            <input
                                                type="number"
                                                class="form-control"
                                        ...
                                        <td
                                            align="right"
                                            class="fit"
                                            v-if="typeof(data.interest) != 'undefined' && data.interest !== null"
                                        >
                                            <input
                                                type="number"
                                                class="form-control"
                                        ...
                                        <td
                                            align="right"
                                            class="fit"
                                            v-if="typeof(data.total_amount) != 'undefined' && data.total_amount !== null"
                                        >
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">$</span>
    ...
    methods: {
        ...
        addField(type, field) {
            switch (type) {
                ...
                case "death_tpd":
                    if (
                        field == "final_expenses" ||
                        field == "children_education" ||
                        field == "children_competition_capital"
                    ) {
                        var empty_obj = {
                            description: "",
                            total_amount: "",
                        ...
                        field == "parents_allowance" ||
                        field == "spouse_allowance" ||
                        field == "children_allowance"
                    ) {
                        var empty_obj = {
                            description: "",
                            amount: "",
