<template>
  <div class="card">
    <div class="card-body">
      <div class="row">
        <div class="col-md-2">
          <img src="/icon/user-icon.png" style="width: 100%" />
        </div>
        <div
          class="col-md-6"
          style="
        ...
        >
          <h1>
            ...
            <template v-if="contact_user.nickname"
              >({{ contact_user.nickname }})</template
            >
          </h1>
      ...
      >
        ...
        <div class="card" v-if="contact_user.preference != null">
        ...
        <div class="card" v-if="contact_user.health != null">
          <div class="card-header" role="tab" id="headingThree3">
            <a
              class="collapsed"
              data-toggle="collapse"
        ...
        <div class="card" v-if="contact_user.values_beliefs != null">
          <div class="card-header" role="tab" id="headingThree3">
            <a
              class="collapsed"
              data-toggle="collapse"
        ...
        <div class="card" v-if="contact_user.achievement != null">
          <div class="card-header" role="tab" id="headingThree3">
            <a
              class="collapsed"
              data-toggle="collapse"
        ...
        <div class="card" v-if="contact_user.education != null">
          <div class="card-header" role="tab" id="headingThree3">
            <a
              class="collapsed"
              data-toggle="collapse"
        ...
        <div class="card" v-if="contact_user.family != null">
          <div class="card-header" role="tab" id="headingThree3">
            <a
              class="collapsed"
              data-toggle="collapse"
        ...
        <div class="card" v-if="contact_user.company != null">
          <div class="card-header" role="tab" id="headingThree3">
            <a
              class="collapsed"
              data-toggle="collapse"
          ...
          >
            <div class="card-body">
              ...
              <b-tabs content-class="mt-3">
                <div v-for="(company, company_index) in contact_user.company">
        ...
        <div class="card" v-if="contact_user.notes != null">
          <div class="card-header" role="tab" id="headingThree3">
            <a
              class="collapsed"
              data-toggle="collapse"
                ...
                <table class="table profile">
                  <tbody>
                    ...
                    <tr>
                      <td class="table-no-border-top text-primary">
                        <b-card
                          v-for="notes in contact_user.notes.notes"
                          class="mb-2"
                        >
                          {{ notes }}
                        </b-card>
...
export default {
  ...
  created() {
    ...
    //this.init();
    axios.get("/vlife/get_contact_profile_data/" + this.id).then((response) => {
      this.contact_user = response.data;
      console.log(this.contact_user);
    });
  },
