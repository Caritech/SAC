...
<div>
                    ...
                    <table class="table table-bordered table-hover table-sm">
                        ...
                        <tbody>
                            <tr v-for="(item, item_key) in g.item" :key="item_key">
                                ...
                                <td>
                                    <cool-select size="sm" single-line :items="['income', 'expense']" v-model="item.type"></cool-select>
                                </td>
                                <td>
                                    <cool-select size="sm" :items="lists_item_input_type" v-model="item.input_type"></cool-select>
                                </td>
                                ...
                                <td>
                                    <template v-if="
                                            ...
                                            " a>
                                        Refer to Group
                                        <cool-select v-model="item.refer_group_id" :items="[]" single-line></cool-select>
                                    </template>
                                </td>
                            </tr>
                        </tbody>
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <div class="row p-2 m-2">
                ...
                <div class="col-6">
                    <cool-select :items="lists_formula_for_half_price" v-model="formula_half_price" itemText="label" itemValue="key"></cool-select>
                </div>
            </div>
            <p>
                UOM explain:
    ...
    <b-modal :title="
        ...
        <cool-select :items="[
                ...
                ]" placeholder="Income / Expense" v-model="new_group_item.type" itemText="text" itemValue="value"></cool-select>
        <cool-select :items="[
                    { text: 'Checkbox', value: 'checkbox' },
                    { text: 'User Enter', value: 'user_enter' },
                    { text: 'Percentage', value: 'percentage' },
                    { text: 'Fixed', value: 'fixed' }
                ]" placeholder="Input Type" v-model="new_group_item.input_type" itemText="text" itemValue="value"></cool-select>
    ...
    <b-modal :title="'Clone From Existing'" ref="modal-clone-existing" hide-footer>
        <cool-select placeholder="Select an existing price plan" :items="lists_price_plan" v-model="price_plan_id_to_clone" itemText="title" itemValue="id"></cool-select>
