 <!-- Topbar Navbar -->
    ...
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
        <h6 class="dropdown-header bg-red">
        Alerts Center
        </h6>
    ...
    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        @if(Auth::user()->profile_image != "" && Auth::user()->profile_image != null )
            <img class="img-profile rounded-circle" src="{{ url('view_image/'.Auth::user()->profile_image) }}">
        @else
            <img class="img-profile rounded-circle" src="{{ asset('images/profile_placeholder.jpg') }}">
        @endif
    </a>
